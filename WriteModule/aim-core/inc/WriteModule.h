...
private:
  ...
  zmq_socket_ext portOutputOut;
  
  static void* readCommandsHelper(void* object) {
    ((WriteModule*)object)->readCommands();
    return NULL;
  }
...
public:
  ...
  /**
   * The "writeOutput" function sends stuff over a zeromq REQ socket. It works as a server. It cannot be blocking because this
