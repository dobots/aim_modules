package org.dobots.writemodule.aim;
...
public class WriteModuleService extends Service {
	private static final String TAG = "WriteModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			WriteModule aim = new WriteModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("WriteModule");
	}
